...
mehndl = lvlvjj( 'VBF125', '/global/dschouten/grids/outputs/merged/VBF/VBF125.root', 'grid', coords, max_size=5000000 )
...
mehndl.set_wc( 30 )
mehndl.set_maxk( 500 ) ## ( min( 5000, mehndl.get_npoints()/2000 ) )
