#=================================================================================================
#
# from MC12JobOptions/share/DSID161xxx/MC12.1610NN.PowhegPythia8_AU2CT10_ggHXYZ_WW2lep_EF_15_5.py
#
evgenConfig.description = "POWHEG+PYTHIA8 ggH H->WW->lvlv with AU2,CT10"
evgenConfig.keywords = ["SMhiggs", "ggF", "W","leptonic"]
evgenConfig.inputfilecheck = "ggH_SM_M"
